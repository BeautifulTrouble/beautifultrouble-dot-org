<?php
/*
Plugin Name: BT Pull-Quotes
Plugin URI: http://striderweb.com/nerdaphernalia/features/wp-javascript-pull-quotes/
Description: Modification of Graceful Pullquotes which places pull quotes in an extremely specific location on the BT site.
Version: 2.4.2
Date: 2014-05-07
			...
			<tbody>
				...
				<tr valign="top">
					...
					<td><label for="omit_styles"><input type="checkbox" name="<?php echo $this->option_name; ?>[omit_styles]" id="omit_styles" value="true"<?php echo( $this->checkflag( $opts, 'omit_styles' ) ); ?> /> <?php $this->p_e( 'Do not link CSS' ); ?></label><br /><?php $this->p_e( 'Check this if you prefer to manually put your pull-quote styles elsewhere' ); ?><br />
						...
						<input type="text" name="<?php echo $this->option_name ?>[quote_class_alt]" id="quote_class_alt" value="<?php echo( $this->checktext( $opts, 'quote_class_alt', 'pullquote pqRight' ) ); ?>"/><label for="quote_class_alt"> <?php $this->p_e( 'Class selector for alt-side pull-quote' ); ?></label><br />
						<input type="text" name="<?php echo $this->option_name ?>[insertion_selector]" id="insertion_selector" value="<?php echo( $this->checktext( $opts, 'insertion_selector', '' ) ); ?>"/><label for="insertion_selector"> <?php $this->p_e( 'Insert pullquotes before this selector' ); ?></label>
					</td>
				</tr>
			</tbody>
		</table>
